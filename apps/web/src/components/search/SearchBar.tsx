...
export function SearchBar() {
  return (
    <SearchField className="relative shrink-0 w-[340px] transition-[width] duration-[260ms] ease-out focus-within:w-[460px] motion-reduce:transition-none max-[880px]:w-full max-[880px]:min-w-0 max-[880px]:focus-within:w-full" />
  );
}
