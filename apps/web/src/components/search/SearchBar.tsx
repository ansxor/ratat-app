...
/**
 * The masthead search, ported from the old app's `SearchBar` with the tag and
 * operator halves left out — Ratat v1 searches actors and nothing else.
 *
...
export function SearchBar() {
  ...
  return (
    <div
      className={cn(
        "relative w-[340px] transition-[width] duration-[180ms] max-[880px]:hidden",
        open && "w-[460px]",
      )}
      onBlur={(event) => {
